...
/**
 * Card del hub de Reportes — mismo molde que las cards de Configuración Global
 * (ícono en caja, título, subtítulo uppercase, descripción) con botón inferior
 * SÓLIDO turquesa + flecha.
 */
