...
--  Agrega `ncgeventos` a la lista pgrst.db_schemas sin reemplazar la lista
...
--
-- Tomar la lista actual obtenida en PASO A y agregar `ncgeventos` al FINAL,
...
--     SET pgrst.db_schemas = '<LISTA_ACTUAL_COMPLETA_PGRST_DB_SCHEMAS>,ncgeventos';
--
...
-- Re-ejecutar el SELECT de pgrst.db_schemas y confirmar que `ncgeventos`
-- aparece al final.
-- ─────────────────────────────────────────────────────────────────────────────
